                        ...
                        <Card>
                            ...
                            {type === 'Opp Client' ?
                                (
                                    <>
                                        <CardHeader>
                                            <Title level={3}>Anand Ranganathan <Tag color="#0a2540">{type}</Tag></Title>
                                        </CardHeader>
                                        <CardBody>
                                            <div
                                                id="map"
                                                            ...
                                                            <Row gutter={[0, 16]} style={{ height: '100%' }}>
                                                                <Col span={24} style={{}}>
                                                                    <div style={{ border: "2px solid black", padding: '10px' }}>
                                                                        ...
                                                                        <Title level={3}>Client Cases</Title>
                                                                        <Table
                                                                            columns={columns}
                                                                            dataSource={data}
                                                                            scroll={{ x: 500, y: 350 }} // Adjust height as needed
                                                        ...
                                                        <Col span={12}>
                                                            <div style={{ border: "2px solid black", padding: '10px' }}>
                                                                ...
                                                                <div style={{ display: "flex", gap: "10%" }}>
                                                                    ...
                                                                    <Form.Item label="Legal Type">
                                                                        <Text strong>Opp Lawyer</Text>
                                                                    </Form.Item>
                                                                    <Form.Item label="Case Type">
                                                                        <Text strong>Civil</Text>
                                                                    </Form.Item>
                                                                </div>
                                                                <Form.Item label="Address">
                                                                    <Text strong>Address of the Lawyer</Text>
                                                                </Form.Item>
